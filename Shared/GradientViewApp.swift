...
final class GradientViewApp: UIView {
    ...
    func blurColor(_ color: UIColor) -> CGColor {
        return color.withAlphaComponent(CGFloat(0.9 - (blurOpacity / 2))).cgColor
    }

    func startEndPoints() -> (CGPoint, CGPoint) {
